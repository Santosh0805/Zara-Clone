  ...
  return (
    <Box height="500px">
      <Flex align="center" justify="center" mt="10%">
        <Text fontSize="md" fontFamily={"Neue-Helvetica, Helvetica, Arial, sans-serif"}
        >
          JOIN OUR NEWSLETTER
        </Text>
      </Flex>
      ...
      <Box>
        <Flex align="center" gap={"5px"} justify="center" mt="10%" fontFamily={"Neue-Helvetica, Helvetica, Arial, sans-serif"}
        >
          <Box p="2%">
            <Text fontSize="sm" fontWeight={200} onClick={() =>
          ...
          <Box p="2%">
            <Text fontSize="sm" fontWeight={200} cursor={"pointer"} onClick={() =>
      ...
      <Box p="np2%" mt={"120px"} ml="15%" mb={"100px"}>
        <Text fontSize="11px" lineHeight={1.2} fontWeight={150} fontFamily={"Neue-Helvetica, Helvetica, Arial, sans-serif"} marginRight={"900px"} textAlign="start"
        >
